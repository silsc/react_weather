...
function Results({weather, date}) {
  ...
  return (
      <FadeIn><div className = "results"><div className = "results-info">
      <h2 className = "location">{weather.name},
      {weather.sys.country}</h2>
        ...
        </FadeIn><FadeIn delay = {800}><div className = "today"><p>
      <span>Today: </span> {todayweather}</p></div>
        </FadeIn>
      </div>
    </FadeIn>);
}
